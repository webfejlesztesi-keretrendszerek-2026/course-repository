...
export class Profile implements OnInit {
  ...
  ngOnInit() {
    ...
    this.form = this.fb.group({
      ...
      password: [''],
      vegetarian: [Array.isArray(d) && d.includes('vegetarian')],
      vegan: [Array.isArray(d) && d.includes('vegan')],
      glutenFree: [Array.isArray(d) && d.includes('glutenFree')],
      lactoseFree: [Array.isArray(d) && d.includes('lactoseFree')],
  ...
  saveProfile() {
    ...
    this.profileService.replaceProfile({
      ...
      diets: [
        ...
        ...(v.vegan ? ['vegan'] : []),
        ...(v.glutenFree ? ['glutenFree'] : []),
        ...(v.lactoseFree ? ['lactoseFree'] : []),
      ],
